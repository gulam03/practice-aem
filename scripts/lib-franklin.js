 ...
 * OF ANY KIND, either exp©ress or implied. See the License for the specific language
 ...
 */
export function loadPrefooter(main) {
  const prefooterBlock = buildBlock('prefooter', '');
  main.append(prefooterBlock);
...
/**
 * loads a block named 'isi' into bottom of body
 */
export function loadIsi(isi) {
  if (!isi) return;

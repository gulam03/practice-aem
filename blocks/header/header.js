...
import { topDisclaimerMarkup } from './disclaimer.js';
import { toggleMainMenu } from './menu.js';
import { toggleBlueTopMenu } from './topmenu.js';
...
function setTitleAndFavicon() {
  if (getMetadata('icon')) {
    document.querySelector('link[rel=icon]').setAttribute('href', getMetadata('icon'));
  }
